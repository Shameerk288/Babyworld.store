        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                ...
                @foreach ($categories as $category)
                    <a href="/shop/category/{{ $category->slug }}"><button type="submit"
                        ...
                        @foreach ($products as $product)
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <a href="/shop/{{ $product->slug }}" style="text-decoration: none;">
                                            <h5 class="fw-bold mb-2">{{ Str::limit($product->name, 23) }}</h5>
                                        </a>
                                        <span style="color: blue;"><b>Rs : {{ $product->original_price }}</b></span>
